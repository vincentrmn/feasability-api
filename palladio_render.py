...
def render_palladio_html(response: Dict[str, Any], adresse: str = "",
    ...
    topbar = (f'<div class="topbar"><span class="brand">Palladio</span>'
              ...
              f'<button type="submit" class="btn-pdf">'
              f'<svg class="pdf-ico" viewBox="0 0 24 24" width="15" height="15" aria-hidden="true">'
              f'<path d="M12 3v10m0 0l-3.5-3.5M12 13l3.5-3.5" fill="none" stroke="currentColor" '
              f'stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>'
              f'<path d="M5 16v3a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-3" fill="none" stroke="currentColor" '
              f'stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'
              f'Télécharger</button></form>'
